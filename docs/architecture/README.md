...
| `enforcement-da-suspensao.architecture.json` | suspensão que PARA o produto (Plano 3) — 14 peças, 19 arestas; o status lido nos três funis de superfície (sessão, token/MCP, claim da fila)|

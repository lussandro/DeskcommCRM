...
Pendência medida: acesso HTTPS por IP/SNI desconhecido chega ao bloco do CRM. Correção prevista: bloco `listen 443 ssl default_server` com `ssl_reject_handshake on`.

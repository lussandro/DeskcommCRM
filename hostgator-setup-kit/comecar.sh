...
# Uso:
#   bash comecar.sh
#   curl -fsSL https://raw.githubusercontent.com/lussandro/bacco-adega-crm/main/hostgator-setup-kit/comecar.sh | bash
#
set -euo pipefail

REPO_URL="${REPO_URL:-https://github.com/lussandro/bacco-adega-crm.git}"

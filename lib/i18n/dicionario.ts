...
export const DICIONARIO: Traducoes = {
  ...
  "Campanha salva.": { es: "Campaña guardada." },
  "1 mensagem a cada": { es: "1 mensaje cada" },
  "no ritmo do número": { es: "al ritmo del número" },
  "horário do número": { es: "horario del número" },
  "teto do número": { es: "tope del número" },
  "Ritmo:": { es: "Ritmo:" },
  "Editar campanha": { es: "Editar campaña" },
  "A campanha já começou — mensagem e ritmo viram histórico e não mudam mais.": { es: "La campaña ya empezó — mensaje y ritmo quedan como histórico y no cambian más." },
  "Ritmo desta campanha": { es: "Ritmo de esta campaña" },
  "Deixe vazio para seguir o número. Preencher só aperta: a campanha nunca fica mais rápida que o número permite.": { es: "Deje vacío para seguir al número. Completar solo aprieta: la campaña nunca va más rápido de lo que el número permite." },
  "Intervalo entre mensagens (segundos)": { es: "Intervalo entre mensajes (segundos)" },
  "vazio = ritmo do número": { es: "vacío = ritmo del número" },
  "Lista fria pede intervalo largo: 300s (5 min) espalha 30 mensagens por 2h30 em vez de 30 minutos.": { es: "Una lista fría pide intervalo amplio: 300s (5 min) reparte 30 mensajes en 2h30 en lugar de 30 minutos." },
  "Começa às": { es: "Empieza a las" },
  "Para às": { es: "Termina a las" },
  "Máximo por dia": { es: "Máximo por día" },
  "Salvar campanha": { es: "Guardar campaña" },
  "Ritmo do envio": { es: "Ritmo del envío" },
  "Lista fria não é atendimento: mandar rápido do mesmo número é o padrão que o WhatsApp bane. Vazio segue o ritmo do número.": { es: "Una lista fría no es atención: enviar rápido desde el mismo número es el patrón que WhatsApp bloquea. Vacío sigue el ritmo del número." },
  "300s espalha 30 mensagens por 2h30, em vez de 30 minutos.": { es: "300s reparte 30 mensajes en 2h30, en lugar de 30 minutos." },
  "Não foi possível salvar a mensagem.": { es: "No fue posible guardar el mensaje." },
  "Mensagem salva.": { es: "Mensaje guardado." },
  "A saudação acima é a de agora — cada pessoa recebe a do horário em que a mensagem sair.": { es: "El saludo de arriba es el de ahora — cada persona recibe el del horario en que salga el mensaje." },
  "Sem {{saudacao}}: se o texto tiver um \"bom dia\" escrito à mão, quem receber às 16h vai ler bom dia.": { es: "Sin {{saudacao}}: si el texto tiene un \"buenos días\" escrito a mano, quien lo reciba a las 16h va a leer buenos días." },
  "Editar mensagem": { es: "Editar mensaje" },
  "A campanha já começou — o texto vira histórico e não muda mais.": { es: "La campaña ya empezó — el texto queda como histórico y no cambia más." },
  "Salvar mensagem": { es: "Guardar mensaje" },
  "Campanha criada, mas a audiência falhou.": { es: "Campaña creada, pero la audiencia falló." },
  "Campanha criada com": { es: "Campaña creada con" },
  "pessoa(s) na fila.": { es: "persona(s) en la cola." },
  "Não foi possível conferir a audiência.": { es: "No fue posible verificar la audiencia." },
  "Como chega agora:": { es: "Cómo llega ahora:" },
  "Sem {{saudacao}}: um \"bom dia\" escrito à mão chega dizendo bom dia às 16h.": { es: "Sin {{saudacao}}: un \"buenos días\" escrito a mano llega diciendo buenos días a las 16h." },
  "Tem estas etiquetas": { es: "Tiene estas etiquetas" },
  "Não tem estas": { es: "No tiene estas" },
  "Nenhuma etiqueta nos contatos desta organização ainda.": { es: "Ninguna etiqueta en los contactos de esta organización todavía." },
  "DDD (separe por vírgula)": { es: "Código de área (separe con coma)" },
  "Quantos neste lote": { es: "Cuántos en este lote" },
  "Conferir quem entra": { es: "Verificar quién entra" },
  "pessoa(s) batem com o filtro;": { es: "persona(s) coinciden con el filtro;" },
  "entram neste lote.": { es: "entran en este lote." },
  "Começa por:": { es: "Empieza por:" },
  "Bloqueados, anonimizados e sem telefone já estão fora desta conta.": { es: "Bloqueados, anonimizados y sin teléfono ya están fuera de esta cuenta." },
  ...
  "Começar a enviar": { es: "Empezar a enviar" },
  "Começar a enviar?": { es: "¿Empezar a enviar?" },
  "pessoa(s) vão receber esta mensagem pelo número": { es: "persona(s) van a recibir este mensaje por el número" },
  "O envio sai um por vez, dentro do limite diário e da janela de horário do número. Você pode pausar a qualquer momento.": { es: "El envío sale uno por vez, dentro del límite diario y de la ventana horaria del número. Puede pausar en cualquier momento." },
  "número removido": { es: "número eliminado" },
  "Não foi possível criar a campanha.": { es: "No fue posible crear la campaña." },
  "número(s) não são contatos desta organização e ficaram de fora.": { es: "número(s) no son contactos de esta organización y quedaron fuera." },
  "Campanha criada como rascunho.": { es: "Campaña creada como borrador." },
  "Nome da campanha": { es: "Nombre de la campaña" },
  "Ex.: Produtores do interior de SP": { es: "Ej.: Productores del interior de SP" },
  "Número que vai falar": { es: "Número que va a hablar" },
  "Quem responder cai no atendimento desse número — inclusive no agente publicado nele.": { es: "Quien responda cae en la atención de ese número — incluido el agente publicado en él." },
  "Use {{primeiro_nome}} para tratar a pessoa pelo nome.": { es: "Use {{primeiro_nome}} para tratar a la persona por su nombre." },
  "Quem não tiver nome no cadastro é pulado quando a mensagem usa o nome — mensagem com buraco denuncia disparo automático.": { es: "Quien no tenga nombre en el registro es omitido cuando el mensaje usa el nombre — un mensaje con hueco delata un envío automático." },
  "Base legal do primeiro contato": { es: "Base legal del primer contacto" },
  "A pessoa consentiu em receber": { es: "La persona consintió en recibir" },
  "Interesse legítimo (LGPD art. 7º, IX)": { es: "Interés legítimo (LGPD art. 7º, IX)" },
  "Referência da avaliação de interesse legítimo (LIA)": { es: "Referencia de la evaluación de interés legítimo (LIA)" },
  "Onde está registrado por que esta prospecção é legítima e como a pessoa se opõe. Sem isso a campanha não começa.": { es: "Dónde está registrado por qué esta prospección es legítima y cómo la persona se opone. Sin eso la campaña no empieza." },
  "Quem vai receber": { es: "Quién va a recibir" },
  "número(s) na lista. Só entram os que já são contatos desta organização.": { es: "número(s) en la lista. Solo entran los que ya son contactos de esta organización." },
  "Um telefone por linha. Só entram os que já são contatos desta organização.": { es: "Un teléfono por línea. Solo entran los que ya son contactos de esta organización." },
  "Criar como rascunho": { es: "Crear como borrador" },
  "Criar não dispara nada: a campanha nasce parada e você confere a lista antes de começar.": { es: "Crear no envía nada: la campaña nace detenida y usted revisa la lista antes de empezar." },
  "Nova campanha": { es: "Nueva campaña" },
  "A campanha nasce parada. Nada é enviado até você conferir a lista e mandar começar.": { es: "La campaña nace detenida. No se envía nada hasta que usted revise la lista y mande empezar." },
  "O envio respeita o limite diário e a janela de horário do número — é o que evita o bloqueio da conta.": { es: "El envío respeta el límite diario y la ventana horaria del número — es lo que evita el bloqueo de la cuenta." },
  "Entregues": { es: "Entregados" },
  "Lidas": { es: "Leídos" },
  "Responderam": { es: "Respondieron" },
  "O funil da campanha": { es: "El embudo de la campaña" },
  "Caiu de enviada para entregue? A lista tem número errado. De entregue para lida? A primeira linha não interessou. De lida para respondida? A oferta não é para esse público.": { es: "¿Cayó de enviado a entregado? La lista tiene números equivocados. ¿De entregado a leído? La primera línea no interesó. ¿De leído a respondido? La oferta no es para ese público." },
  "Nada saiu ainda — o funil aparece quando a primeira mensagem for enviada.": { es: "Todavía no salió nada — el embudo aparece cuando se envíe el primer mensaje." },
  "Pessoas": { es: "Personas" },
  "O ritmo, dia a dia": { es: "El ritmo, día a día" },
  "Uma campanha saudável sobe devagar: o limite diário do número é o que protege a conta de ser bloqueada.": { es: "Una campaña sana sube despacio: el límite diario del número es lo que protege la cuenta de ser bloqueada." },
  "Ainda não há dias com envio.": { es: "Todavía no hay días con envío." },
  "Quem não entrou na corrida": { es: "Quién no entró en la carrera" },
  "Estes não receberam nada. O motivo diz o que consertar antes da próxima campanha.": { es: "Estos no recibieron nada. El motivo dice qué corregir antes de la próxima campaña." },
  "de toda a lista": { es: "de toda la lista" },
  "Campanhas": { es: "Campañas" },
  "Prospecção ativa pelo WhatsApp, no ritmo que não queima o número: uma mensagem por vez, dentro da janela do canal.": { es: "Prospección activa por WhatsApp, al ritmo que no quema el número: un mensaje por vez, dentro de la ventana del canal." },
  "Nenhuma campanha ainda": { es: "Ninguna campaña todavía" },
  "Uma campanha precisa de um número, um texto e a base legal do primeiro contato. Sem base legal declarada ela não começa — é o que separa prospecção de spam.": { es: "Una campaña necesita un número, un texto y la base legal del primer contacto. Sin base legal declarada no empieza — es lo que separa prospección de spam." },
  "Na fila": { es: "En la cola" },
  "Enviadas": { es: "Enviadas" },
  "Puladas": { es: "Omitidas" },
  "Falharam": { es: "Fallaron" },
  "Total": { es: "Total" },
  "Ver quem recebeu e quem foi pulado": { es: "Ver quién recibió y quién fue omitido" },
  "Com consentimento": { es: "Con consentimiento" },
  "Interesse legítimo": { es: "Interés legítimo" },
  "sem referência": { es: "sin referencia" },
  "A mensagem": { es: "El mensaje" },
  "É o que cada pessoa da lista recebe, com o nome dela no lugar da variável.": { es: "Es lo que cada persona de la lista recibe, con su nombre en lugar de la variable." },
  "Quem está na lista": { es: "Quién está en la lista" },
  "Nenhum destinatário ainda.": { es: "Ningún destinatario todavía." },
  "Enviando": { es: "Enviando" },
  "Pulado": { es: "Omitido" },
